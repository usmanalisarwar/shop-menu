	...
	<div class="container-fluid my-2">
		<div class="row mb-2">
			...
			<div class="col-sm-6 text-right">
                ...
                @endphp
				@if(hasPermissions($permissions, 'add-new-menu-item')) <!-- Check permission for adding a new menu item -->
				...
				<table class="table table-hover text-nowrap">
					...
					<tbody>
                        ...
                        <tr>
							...
							<td>
								@if(hasPermissions($permissions, 'edit-menu-item')) <!-- Check permission for editing -->
								...
								@if(hasPermissions($permissions, 'delete-menu-item')) <!-- Check permission for deletion -->
