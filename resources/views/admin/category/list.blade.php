...
<section class="content-header">					
	<div class="container-fluid my-2">
		<div class="row mb-2">
			...
			@if(hasPermissions(getAuthUserModulePermissions(), 'add-new-category')) <!-- Check for create permission -->
				...
				<table class="table table-hover text-nowrap">
					...
					<tbody>
                        ...
                        <tr>
							...
							<td>
								@if(hasPermissions(getAuthUserModulePermissions(), 'edit-category')) <!-- Check for edit permission -->
								...
								@endif
								@if(hasPermissions(getAuthUserModulePermissions(), 'delete-category')) <!-- Check for delete permission -->
