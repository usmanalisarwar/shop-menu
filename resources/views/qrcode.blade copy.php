...
<head>
    ...
    <style>
        ...
        .qr-container {
            position: relative;
            top: 38%;
            /* Adjust the position on the image */
            left: -50%;
            margin-top: 300px;
            ...
            padding: 10px;
            /* Optional: adds padding around the QR code */
            z-index: 2;
        }
        ...
        @media (max-width: 768px) {
            .qr-container {
                top: 40%;
                /* Adjust QR code position for smaller screens */
                left: -268px;
                /* Center the QR code more */
                transform: translate(-50%, -50%);
                max-width: 150px;
                /* Scale down the QR code size */
        ...
        @media (max-width: 480px) {
            .qr-container {
                top: 22%;
                /* Keep centered for mobile */
                left: -68%;
                transform: translate(-50%, -50%);
                max-width: 121px;
                /* Smaller QR code size on mobile */
                width: 30%;
                /* Increase width as per screen size */
                padding: 0px;
                background: none;
...
<body>
    ...
    <div class="bg-white p-0">
        ...
        <div class="position-relative p-0">
            ...
            <div class="container">
                @if ($menuImage)
                <img src="{{ asset('uploads/menu/' . $menuImage->image) }}" class="menu-image" alt="Menu Image">
                @else
                <img src="{{ asset('uploads/menu/default.jpg') }}" class="menu-image" alt="Default Image">
                @endif
