...
<section class="menu" id="popular">
        <h2>🔥 Popular</h2>
        <p>Most ordered right now.</p>
        
        <div class="menu-grid">
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/chicken.jpg')}}" alt="Chicken Supreme">
                <div class="item-details">
                    <h3>Chicken Supreme</h3>
                    <p class="price">from Rs. 698</p>
                    <p class="description">Chicken tikka, chicken sausages, cheese, black olives, capsicum, mushrooms</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/sandwish.jpg')}}" alt="Chicken Club Sandwich">
                <div class="item-details">
                    <h3>Chicken Club Sandwich</h3>
                    <p class="price">Rs. 698</p>
                    <p class="description">Chicken, egg, cucumber, tomatoes, chilli sauce, lettuce, ketchup and mayo</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/fajita1.jpg')}}" alt="Chicken Fajita">
                <div class="item-details">
                    <h3>Chicken Fajita</h3>
                    <p class="price">from Rs. 698</p>
                    <p class="description">Chicken fajita, cheese, capsicum, mushrooms and onions</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/tikka.jpg')}}" alt="Chicken Tikka">
                <div class="item-details">
                    <h3>Chicken Tikka</h3>
                    <p class="price">from Rs. 698</p>
                    <p class="description">Chicken tikka, cheese and onions</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/burger.jpg')}}" alt="Beef Cheese Burger">
                <div class="item-details">
                    <h3>Beef Cheese Burger</h3>
                    <p class="price">Rs. 698</p>
                    <p class="description">Special cheese, thousand island sauce and crispy onions</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/smoke.jpg')}}" alt="Smoked Chicken">
                <div class="item-details">
                    <h3>Smoked Chicken</h3>
                    <p class="price">Rs. 698</p>
                    <p class="description">Smoked chicken, cheese, mushrooms and onions</p>
                </div>
...
<section class="menu" id="cakes" style="display: none;">
        <h2>Cakes</h2>
        <!-- <p>Most ordered right now.</p> -->
...
<section class="menu" id="fish" style="display: none;">
        <h2>Fish</h2>
        <!-- <p>Most ordered right now.</p> -->
        
        <div class="menu-grid">
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/fish.jpg')}}" alt="Chicken Supreme">
                <div class="item-details">
                    <h3>Grilled Fish</h3>
                    <p class="price">from Rs. 1050</p>
                    <p class="description">Succulent grilled fish, perfectly seasoned and served with a zesty lemon garnish for a delightful, fresh dining experience.</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/fish2.jpg')}}" alt="Chicken Club Sandwich">
                <div class="item-details">
                    <h3>Fried Fish</h3>
                    <p class="price">Rs. 998</p>
                    <p class="description">Crispy, golden-fried fish served fresh with a hint of lemon – a perfect taste of the sea.</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/chips.jpg')}}" alt="Chicken Fajita">
                <div class="item-details">
                    <h3>Fish & Chips</h3>
                    <p class="price">from Rs. 898</p>
                    <p class="description">Enjoy classic, crispy Fish & Chips with fresh flavors and a seaside feel at our hotel restaurant.</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/garlic.jpg')}}" alt="Chicken Tikka">
                <div class="item-details">
                    <h3>Garlic Lemongrass</h3>
                    <p class="price">from Rs. 1090</p>
                    <p class="description">One of my favorite fishes to cook is a halibut. It's meaty and absorbs any flavor it's seasoned with.</p>
                </div>
            </div>
            
            <div class="menu-item">
                <img src="{{ asset('front-assets/img/beked1.jpg')}}" alt="Beef Cheese Burger">
                <div class="item-details">
                    <h3>Baked Fish</h3>
                    <p class="price">Rs. 698</p>
                    <p class="description">Delicately baked fish, seasoned to perfection, offering a fresh and flavorful taste of the sea.</p>
                </div>
            </div>
    ...
    <section class="menu" id="pizzas" style="display: none;">
        <h2>Pizzas</h2>
        <p>Most ordered right now.</p>
    ...
    <section class="menu" id="premium-desserts" style="display: none;">
        <h2>premium Desserts</h2>
        <p>Most ordered right now.</p>
    ...
    <section class="menu" id="peri-peri-chicken" style="display: none;">
    ...
    <section class="menu" id="gril-fish" style="display: none;">
        <h2>Gril Fish</h2>
        <p>Most ordered right now.</p>
    ...
    <section class="menu" id="chicken-tikka" style="display: none;">
        <h2>Chicken Tikka</h2>
        <p>Most ordered right now.</p>
